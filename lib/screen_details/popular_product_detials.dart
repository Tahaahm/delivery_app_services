// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, sized_box_for_whitespace, unused_local_variable, prefer_interpolation_to_compose_strings, curly_braces_in_flow_control_structures, avoid_print
...
class _PopularFoodDetailState extends State<PopularFoodDetail> {
  ...
  Widget build(BuildContext context) {
    var product = widget.page == "home"
        ? Get.find<PopularController>().popularProductList[widget.pageId]
        : widget.page == "meat"
            ? Get.find<MeatPopularController>().meatProduct[widget.pageId]
            : Get.find<DesertController>().desertProduct[widget.pageId];
