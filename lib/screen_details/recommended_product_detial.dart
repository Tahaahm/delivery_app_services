// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, sized_box_for_whitespace, unused_local_variable, prefer_interpolation_to_compose_strings
...
class RecommendFoodDetails extends StatefulWidget {
  ...
  final String page;
  @override
  State<RecommendFoodDetails> createState() => _RecommendFoodDetailsState();
}

class _RecommendFoodDetailsState extends State<RecommendFoodDetails> {
  List<IconData> icons = [
  ...
  Widget build(BuildContext context) {
    var product = widget.page == "reco"
        ? Get.find<RecommendProductController>().recommendProduct[widget.pageId]
        : widget.page == "desert-popular"
            ? Get.find<DesertSweetController>().desertProduct[widget.pageId]
            : Get.find<MeatController>().meatProduct[widget.pageId];
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        BigText(
                          text: product.price!.toStringAsFixed(2).toString(),
                          color: AppColor.greyColor,
